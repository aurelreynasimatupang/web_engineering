...
export default function ProperyUpdate(){
    ...
    const [setLongitude] = useState(inputDataUpdated[0].longitude);
    const [setLatitude] = useState(inputDataUpdated[0].latitude);
    ...
    function UpdateInfo(){
        ...
        lastData[0].latitude=inputDataUpdated[0].latitude
        lastData[0].longitude=inputDataUpdated[0].longitude
        lastData[0].is_active = isActive
        fetch(`http://localhost:3001/?longitude=${inputDataUpdated[0].longitude}&latitude=${inputDataUpdated[0].latitude}` ,{
            method : 'PUT',
            headers:{
                ...
                <div className="propertyListUpdated">
                 ...
                 {stateUpdated.map(({id,city,rent,deposit,longitude,latitude,postalCode,costSqm,title,is_active}) => {
                    ...
                    return(<div className="propertyListTexts">
                        ...
                        <p><button className="btnProp" id="buttonProp" onClick={()=> UpdateInfo()}>Update</button></p>
